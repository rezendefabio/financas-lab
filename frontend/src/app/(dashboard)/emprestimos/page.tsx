...
import { TIPOS_EMPRESTIMO } from '@/features/emprestimos/components/EmprestimoForm'
...
import type { Emprestimo } from '@/features/emprestimos/types/emprestimo'

const SCREEN_CODE = 'FIN-EMP-001'

const TIPO_LABEL: Record<string, string> = Object.fromEntries(
  TIPOS_EMPRESTIMO.map((t) => [t.value, t.label]),
)
