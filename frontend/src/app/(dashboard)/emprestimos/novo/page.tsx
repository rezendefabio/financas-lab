...
import type { CriarEmprestimoPayload } from '@/features/emprestimos/types/emprestimo'
import { Card, CardContent } from '@/shared/components/ui/card'
import { Button } from '@/shared/components/ui/button'

function toCriarPayload(values: EmprestimoFormValues): CriarEmprestimoPayload {
  return {
...
export default function NovoEmprestimoPage() {
  ...
  const mutation = useMutation({
    mutationFn: (values: EmprestimoFormValues) =>
      emprestimosService.criar(toCriarPayload(values)),
    onSuccess: async () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-semibold tracking-tight">Novo Emprestimo</h1>
      </div>
