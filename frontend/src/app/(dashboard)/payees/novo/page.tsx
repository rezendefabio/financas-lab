...
export default function NovoPayeePage() {
  ...
  const mutation = useMutation({
    mutationFn: (values: FormValues) =>
      criarPayee({
        nome: values.nome,
        ...(values.categoriaPadraoId ? { categoriaPadraoId: values.categoriaPadraoId } : {}),
      }),
    onSuccess: async () => {
    ...
    onError: () => {
      setApiError('Erro ao criar beneficiario.')
    },
  })
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-semibold tracking-tight">Novo Beneficiario</h1>
      </div>
