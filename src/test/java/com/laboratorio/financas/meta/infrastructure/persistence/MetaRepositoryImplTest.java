...
class MetaRepositoryImplTest extends AbstractIntegrationTest {
    ...
    void listarRetornaTodasAsMetasSalvas() {
        // Given
        Meta m1 = new Meta("Meta A", new Money(new BigDecimal("1000.00"), BRL), PRAZO_FUTURO);
        Meta m2 = new Meta("Meta B", new Money(new BigDecimal("2000.00"), BRL), PRAZO_FUTURO);
        Meta m3 = new Meta("Meta C", new Money(new BigDecimal("3000.00"), BRL), PRAZO_FUTURO);
    ...
    void listarRetornaMetasComStatusDiferentes() {
        // Given
        Meta ativa = new Meta("Meta Ativa", new Money(new BigDecimal("1000.00"), BRL), PRAZO_FUTURO);
        Meta cancelada = new Meta("Meta Cancelada", new Money(new BigDecimal("2000.00"), BRL), PRAZO_FUTURO);
