...
public class EmprestimoEntity {
    ...
    @AttributeOverrides({
        @AttributeOverride(name = "valor",
            column = @Column(name = "valor_amount", nullable = false, precision = 19, scale = 4)),
        @AttributeOverride(name = "moeda",
            column = @Column(name = "valor_currency", nullable = false, length = 3))
    })
    ...
    public EmprestimoEntity(UUID id, UUID userId, String descricao, String nomeTerceiro,
                            TipoEmprestimo tipo, MoneyEmbeddable valor,
                            LocalDate dataEmprestimo, boolean quitado,
