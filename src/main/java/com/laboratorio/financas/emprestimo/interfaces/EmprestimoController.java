...
import com.laboratorio.financas.emprestimo.application.ExcluirEmprestimoUseCase;
...
public class EmprestimoController {
    ...
    private final BuscarEmprestimoPorIdUseCase buscarPorIdUseCase;
    private final AtualizarEmprestimoUseCase atualizarUseCase;
    private final ExcluirEmprestimoUseCase excluirUseCase;
    ...
    public EmprestimoController(CriarEmprestimoUseCase criarUseCase,
                                ...
                                BuscarEmprestimoPorIdUseCase buscarPorIdUseCase,
    ...
    @GetMapping("/{id}")
    public EmprestimoResponse buscarPorId(@PathVariable UUID id,
                                          Authentication authentication) {
        resolverUserId(authentication);
        return EmprestimoResponse.fromDomain(buscarPorIdUseCase.executar(id));
    }
    ...
    public EmprestimoResponse atualizar(
            ...
            @RequestHeader(value = "X-Screen-Code", required = false) String screenCode) {
        resolverUserId(authentication);
        Emprestimo antes = buscarPorIdUseCase.executar(id);
