...
public final class Emprestimo {
    ...
    public Emprestimo(UUID id,
        ...
        this.nomeTerceiro = (nomeTerceiro == null || nomeTerceiro.isBlank())
                ? null : nomeTerceiro.trim();
        this.tipo = tipo;
        this.valor = valor;
    ...
    private static void validarNomeTerceiro(String nomeTerceiro) {
        ...
        if (nomeTerceiro.length() > NOME_TERCEIRO_MAX_LENGTH) {
            throw new IllegalArgumentException(
