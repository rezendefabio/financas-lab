...
public final class Emprestimo {
    ...
    public Emprestimo(UUID id, UUID userId, String descricao, String nomeTerceiro,
        ...
        validarValor(valor);
        Objects.requireNonNull(dataEmprestimo, "dataEmprestimo nao pode ser nula");
    ...
    private static void validarNomeTerceiro(String nomeTerceiro) {
        ...
        if (nomeTerceiro.trim().length() > NOME_TERCEIRO_MAX_LENGTH) {
            throw new IllegalArgumentException(
    ...
    public void atualizar(String novaDescricao, String novoNomeTerceiro, TipoEmprestimo novoTipo,
                          Money novoValor, LocalDate novaDataEmprestimo, boolean novoQuitado) {
        ...
        Objects.requireNonNull(novaDataEmprestimo, "dataEmprestimo nao pode ser nula");
