...
public final class Lembrete {
    ...
    private PrioridadeLembrete prioridade;
    private boolean concluido;
    private final Instant criadoEm;
    private Instant atualizadoEm;

    public Lembrete(UUID userId, String titulo, String descricao, LocalDate dataLembrete,
                    PrioridadeLembrete prioridade, boolean concluido) {
        this(UUID.randomUUID(), userId, titulo, descricao, dataLembrete, prioridade,
                concluido, Instant.now(), null);
    }

    public Lembrete(UUID id, UUID userId, String titulo, String descricao, LocalDate dataLembrete,
                    PrioridadeLembrete prioridade, boolean concluido,
    ...
    private static void validarDataLembrete(LocalDate dataLembrete) {
        Objects.requireNonNull(dataLembrete, "dataLembrete nao pode ser nulo");
    }

    private static void validarPrioridade(PrioridadeLembrete prioridade) {
        Objects.requireNonNull(prioridade, "prioridade nao pode ser nulo");
    }

    public void atualizar(String novoTitulo, String novaDescricao, LocalDate novaDataLembrete,
                          PrioridadeLembrete novaPrioridade, boolean novoConcluido) {
        validarTitulo(novoTitulo);
        validarDescricao(novaDescricao);
        validarDataLembrete(novaDataLembrete);
    ...
    public PrioridadeLembrete getPrioridade() {
        return prioridade;
    }
